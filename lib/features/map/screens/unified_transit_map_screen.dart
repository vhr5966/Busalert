...
class _UnifiedTransitMapScreenState
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Departs: ${dep.scheduledDeparture}',
                                          style: const TextStyle(
                                            fontSize: 11,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      if (dep.minutesUntilText(DateTime.now()).isNotEmpty)
                                        Text(
  ...
  Widget build(BuildContext context) {
    ...
    // Add Bus Stop Markers (Distinct Stop Pin Icon)
    if (showStops) {
          ...
          Marker(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: const Center(
                  child: Icon(Icons.place_rounded, size: 13, color: Colors.white),
                ),
              ),
            ),
          ),
    ...
    // Add Live Moving Bus Markers (Distinct Bus Icon Badge)
    if (showBuses) {
