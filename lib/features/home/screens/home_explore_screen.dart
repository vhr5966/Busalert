...
import 'transit_search_screen.dart';
...
class _HomeExploreScreenState extends ConsumerState<HomeExploreScreen> {
  ...
  Future<void> _openSearchScreen({bool isPlanMode = false}) async {
    final chosen = await Navigator.of(context).push<BusStop>(
      MaterialPageRoute(
        builder: (_) => TransitSearchScreen(isPlanMode: isPlanMode),
      ),
    );
  ...
  Future<void> _openJourneyPlanner() async {
    final stops = await _stopService.getStops();
    if (mounted) {
      showModalBottomSheet<void>(
        context: context,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        borderRadius: BorderRadius.circular(14),
                        onTap: () => _openSearchScreen(isPlanMode: false),
                        child: Padding(
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: const Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                      Icon(Icons.alt_route_rounded, size: 13, color: Color(0xFF2563EB)),
                                      SizedBox(width: 4),
                                      Text(
                                        'Plan',
                                        style: TextStyle(
            ...
            // ── Active Planned Journey Banner (if destination selected) ──
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Container(
                          ...
                          child: Text(
                            'Bus ${plannerState.journeys.first.routeNumber}',
                            style: const TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                              fontSize: 11,
                        ...
                        Expanded(
                          child: Text(
                            'Trip to ${plannerState.destinationStop!.name}',
                            style: const TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.bold,
                    ...
                    Row(
                      children: [
                        Text(
                          'Departs ${plannerState.journeys.first.departureTime} (${plannerState.journeys.first.durationMinutes} mins)',
